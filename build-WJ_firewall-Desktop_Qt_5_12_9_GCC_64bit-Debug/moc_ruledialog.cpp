...
void RuleDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (RuleDialog::*)(rule_str_tp );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RuleDialog::addNewRuleSignal)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject RuleDialog::staticMetaObject = { {
    &QDialog::staticMetaObject,
    qt_meta_stringdata_RuleDialog.data,
