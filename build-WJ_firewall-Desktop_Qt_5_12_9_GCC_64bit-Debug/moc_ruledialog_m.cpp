...
void ruledialog_m::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ruledialog_m *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (ruledialog_m::*)(rule_str_tp );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ruledialog_m::modRuleSignal)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject ruledialog_m::staticMetaObject = { {
    &QDialog::staticMetaObject,
    qt_meta_stringdata_ruledialog_m.data,
    qt_meta_data_ruledialog_m,
    qt_static_metacall,
    nullptr,
    nullptr
} };
